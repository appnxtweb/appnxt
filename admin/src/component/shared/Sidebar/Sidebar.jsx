        ...
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            <NavLink to="/services" className="nav-link ">
              ...
              <span className="nav-link-text ms-1">List Services</span>
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link  " to="/create-service">
              ...
              <span className="nav-link-text ms-1">Create Service</span>
            </NavLink>
          </li>
          <li className="nav-item mt-3">
            <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">
          ...
          <li className="nav-item">
            <NavLink to="/banners" className="nav-link ">
              ...
              <span className="nav-link-text ms-1">List Banner</span>
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink to="project" className="nav-link ">
              ...
              <span className="nav-link-text ms-1">List Projects</span>
            </NavLink>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item">
            <NavLink className="nav-link  " to="procedure">
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg
                  width="12px"
                  height="12px"
              ...
              <span className="nav-link-text ms-1">Work Process</span>
            </NavLink>
          </li>
          <li className="nav-item mt-3">
            <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">
